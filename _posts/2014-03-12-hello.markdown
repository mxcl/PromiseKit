...
The answer is: yes, it does. If you need the catch to cause complete stoppage either throw again (often: a code smell), or restructure your promises, probably you didn’t want them to chain in this manner.
